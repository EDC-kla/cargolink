...
const Hero = ({ onGetStarted }: HeroProps) => {
  ...
  return (
    <div className="relative bg-gradient-to-b from-white to-accent/30 pt-20 pb-32 overflow-hidden">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="text-sm font-medium text-gray-700">From Where?</label>
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium text-gray-700">To Where?</label>
                  <div className="relative">
                    <MapPin className="absolute left-4 top-3.5 h-5 w-5 text-gray-400" />
                    <Input
